...
import 'package:myethermine/models/error.dart';
...
class DashboardApiClient {
  ...
  Future<Dashboard> fetchDashboard() async {
    final ethUrl = '$_baseUrl/0x460a6deec1d52c9c397fghe92fdc8c4bc05d10f8429/currentStats';
  ...
  Future<ErrorMes> fetchDashboardError() async {
    final ethUrl = '$_baseUrl/miner/0x460a6deec1d52c9c397fghe92fdc8c4bc05d10f8429/currentStats';
    final ethResponse = await this.httpClient.get(ethUrl);
    if (ethResponse.statusCode != 200) {
      throw Exception('Error server');
    }
